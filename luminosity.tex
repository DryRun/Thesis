...
\begin{figure}[htbp]
	...
	\subfloat[] {\label{fig:reco-luminosity-runI}
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/reconstruction/intlumivstime2011-2012DQ.eps}}
	}
	\hfill
	\subfloat[] {\label{fig:reco-luminosity-pileup}
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/reconstruction/mu_2011_2012-dec.eps}}
	}
	\hfill
