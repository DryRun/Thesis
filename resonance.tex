...
\end{equation}
where $\Psi\equiv {\lplus_R}^c + \lminus_R$ is a Dirac spinor representing the four charged degrees of freedom, $\psi_{\ell}$ are Dirac spinors corresponding to the Standard Model leptons, $\phi\equiv(\phi^+,\phi^0)^T\equiv (\phi^+,(v+H+i\eta)/\sqrt{2})^T$ is the Higgs doublet, and $Y_{L \ell}$ are Yukawa couplings. After electroweak symmetry breaking, the mass matrices take the form
\begin{equation}
...
\begin{figure}[h]
  \centering
  \subfloat[] {
    \resizebox{0.48\textwidth}{!}{\includegraphics{figures/resonance/c_br_charged}}
  }
  \hfill
  \subfloat[] {
    \resizebox{0.48\textwidth}{!}{\includegraphics{figures/resonance/c_br_neutral}}
  }
...
\begin{table}[ht]
	...
	\begin{tabular}{|c|c|c|c|c|c||c|c|c|}
		\hline
		Process  & Preselection  & Bachelor $e$  & $|m_{\ell^{+}\ell^{-}} - m_{Z}|<10~\mbox{GeV}$  & Veto $2Z$  & $\Delta R < 3.0$  & $\fourl$ & $\threeljj$ & $\threelo$ \\
		\hline
		VLL, $100$~GeV		&	$34.8 \pm 0.8$	&	$31.8 \pm 0.8$	&	$30.6 \pm 0.8$	&	$30.3 \pm 0.8$	&	$29.8 \pm 0.8$	&	$5.4 \pm 0.4$ &	$9.6 \pm 0.5$	&	$14.7 \pm 0.6$	\\
		\hline
		VLL, $110$~GeV		&	$47.8 \pm 0.6$	&	$43.5 \pm 0.6$	&	$42.1 \pm 0.6$	&	$41.7 \pm 0.6$	&	$40.1 \pm 0.6$	&	$7.6 \pm 0.3$ &	$11.0 \pm 0.4$	&	$21.5 \pm 0.5$	\\
		\hline
		VLL, $120$~GeV		&	$53.5 \pm 0.6$	&	$49.1 \pm 0.6$	&	$46.7 \pm 0.6$	&	$45.7 \pm 0.6$	&	$42.4 \pm 0.6$	&	$10.4 \pm 0.4$ &	$11.7 \pm 0.4$	&	$20.4 \pm 0.5$	\\
		\hline
		VLL, $130$~GeV		&	$60.4 \pm 0.6$	&	$53.9 \pm 0.6$	&	$50.9 \pm 0.6$	&	$49.4 \pm 0.6$	&	$44.5 \pm 0.6$	&	$12.5 \pm 0.4$ &	$12.7 \pm 0.4$	&	$19.4 \pm 0.5$	\\
		\hline
		VLL, $140$~GeV		&	$64.3 \pm 0.6$	&	$57.8 \pm 0.6$	&	$55.9 \pm 0.6$	&	$53.8 \pm 0.6$	&	$49.1 \pm 0.6$	&	$15.3 \pm 0.4$ &	$16.4 \pm 0.4$	&	$17.4 \pm 0.5$	\\
		\hline
		VLL, $160$~GeV		&	$66.3 \pm 0.6$	&	$59.3 \pm 0.6$	&	$57.2 \pm 0.6$	&	$55.2 \pm 0.6$	&	$49.9 \pm 0.6$	&	$17.5 \pm 0.5$ &	$14.8 \pm 0.4$	&	$17.6 \pm 0.5$	\\
		\hline
		VLL, $180$~GeV		&	$69.8 \pm 0.6$	&	$62.0 \pm 0.6$	&	$59.4 \pm 0.6$	&	$57.3 \pm 0.7$	&	$50.5 \pm 0.7$	&	$19.7 \pm 0.5$ &	$16.3 \pm 0.5$	&	$14.4 \pm 0.5$	\\
		\hline
		VLL, $200$~GeV		&	$70.7 \pm 0.6$	&	$62.4 \pm 0.7$	&	$59.6 \pm 0.7$	&	$57.7 \pm 0.7$	&	$52.0 \pm 0.7$	&	$20.9 \pm 0.6$ &	$16.7 \pm 0.5$	&	$14.5 \pm 0.5$	\\
		\hline
		VLL, $250$~GeV		&	$75.1 \pm 0.7$	&	$65.4 \pm 0.7$	&	$62.6 \pm 0.7$	&	$61.5 \pm 0.7$	&	$54.8 \pm 0.8$	&	$24.5 \pm 0.7$ &	$15.2 \pm 0.5$	&	$15.1 \pm 0.5$	\\
		\hline
		VLL, $300$~GeV		&	$77.1 \pm 0.7$	&	$66.2 \pm 0.8$	&	$63.0 \pm 0.8$	&	$62.5 \pm 0.8$	&	$54.7 \pm 0.8$	&	$25.8 \pm 0.7$ &	$16.9 \pm 0.6$	&	$12.1 \pm 0.5$	\\
		\hline
		VLL, $400$~GeV		&	$77.6 \pm 0.7$	&	$66.9 \pm 0.8$	&	$64.2 \pm 0.8$	&	$64.1 \pm 0.8$	&	$56.2 \pm 0.8$	&	$27.7 \pm 0.7$ &	$18.1 \pm 0.6$	&	$10.3 \pm 0.5$	\\
		\hline
...
\begin{table}[ht]
	...
	\begin{tabular}{|c|c|c|c|c|c||c|c|c|}
		\hline
		Process  & Preselection  & Bachelor $\mu$  & $|m_{l^{+}l^{-}} - m_{Z}|<10~\mbox{GeV}$  & Veto $2Z$  & $\Delta R < 3.0$  & $4l$ & $3l+jj$ & Else \\
		\hline
		VLL, $100$~GeV	&	$52.0 \pm 0.7$	&	$50.8 \pm 0.7$	&	$47.2 \pm 0.7$	&	$46.1 \pm 0.7$	&	$45.6 \pm 0.7$	&	$6.4 \pm 0.4$ &	$14.0 \pm 0.5$	&	$25.2 \pm 0.6$\\
		\hline
		VLL, $110$~GeV	&	$61.0 \pm 0.4$	&	$59.3 \pm 0.4$	&	$56.8 \pm 0.4$	&	$55.4 \pm 0.4$	&	$53.6 \pm 0.4$	&	$11.9 \pm 0.3$ &	$14.2 \pm 0.3$	&	$27.5 \pm 0.4$\\
		\hline
		VLL, $120$~GeV	&	$67.0 \pm 0.3$	&	$64.8 \pm 0.4$	&	$61.7 \pm 0.4$	&	$59.6 \pm 0.4$	&	$56.1 \pm 0.4$	&	$14.9 \pm 0.3$ &	$13.9 \pm 0.3$	&	$27.3 \pm 0.3$\\
		\hline
		VLL, $130$~GeV	&	$70.2 \pm 0.3$	&	$67.6 \pm 0.3$	&	$64.2 \pm 0.3$	&	$61.4 \pm 0.3$	&	$56.9 \pm 0.3$	&	$16.3 \pm 0.3$ &	$14.3 \pm 0.2$	&	$26.3 \pm 0.3$\\
		\hline
		VLL, $140$~GeV	&	$72.3 \pm 0.3$	&	$70.1 \pm 0.3$	&	$66.7 \pm 0.3$	&	$63.4 \pm 0.3$	&	$58.5 \pm 0.3$	&	$17.3 \pm 0.3$ &	$15.6 \pm 0.2$	&	$25.6 \pm 0.3$\\
		\hline
		VLL, $160$~GeV	&	$75.2 \pm 0.3$	&	$72.7 \pm 0.3$	&	$68.5 \pm 0.3$	&	$65.0 \pm 0.3$	&	$59.2 \pm 0.3$	&	$21.2 \pm 0.3$ &	$15.6 \pm 0.2$	&	$22.3 \pm 0.3$\\
		\hline
		VLL, $180$~GeV	&	$77.0 \pm 0.3$	&	$74.6 \pm 0.3$	&	$69.0 \pm 0.3$	&	$65.9 \pm 0.3$	&	$59.3 \pm 0.3$	&	$22.7 \pm 0.3$ &	$16.1 \pm 0.2$	&	$20.5 \pm 0.3$\\
		\hline
		VLL, $200$~GeV	&	$77.9 \pm 0.3$	&	$75.1 \pm 0.3$	&	$69.0 \pm 0.3$	&	$66.0 \pm 0.3$	&	$58.4 \pm 0.3$	&	$23.9 \pm 0.3$ &	$16.1 \pm 0.2$	&	$18.4 \pm 0.2$\\
		\hline
		VLL, $250$~GeV	&	$78.6 \pm 0.3$	&	$75.2 \pm 0.3$	&	$67.6 \pm 0.3$	&	$65.7 \pm 0.3$	&	$57.9 \pm 0.3$	&	$26.8 \pm 0.3$ &	$16.2 \pm 0.2$	&	$14.9 \pm 0.2$\\
		\hline
		VLL, $300$~GeV	&	$78.9 \pm 0.2$	&	$76.0 \pm 0.3$	&	$68.0 \pm 0.3$	&	$66.7 \pm 0.3$	&	$57.8 \pm 0.3$	&	$28.8 \pm 0.3$ &	$16.3 \pm 0.2$	&	$12.7 \pm 0.2$\\
		\hline
		VLL, $400$~GeV	&	$78.7 \pm 0.2$	&	$75.3 \pm 0.3$	&	$66.5 \pm 0.3$	&	$65.6 \pm 0.3$	&	$56.3 \pm 0.3$	&	$29.2 \pm 0.3$ &	$16.6 \pm 0.2$	&	$10.6 \pm 0.2$\\
		\hline
...
\begin{itemize}
	...
	%\sherpa, \sherpa\ with \texttt{mll4} filter, and \powheg\ are compared in figure~\ref{fig:ZZ-mll4}. 
...
%	\end{figure}
	...
	\begin{figure}[h]
		...
		\caption{Comparison of the $\deltam$ distributions between \powheg\ and \sherpa\ for the $ZZ$ backgrounds. The top panels show the $\deltam$ distributions, normalized to unity, and the bottom panels show the ratio of \powheg\ to \sherpa. The shaded bands and error bars represent the statistical uncertainties. The \powheg\ events are weighted to account for the \texttt{mll4} filter.}
...
The impact of each uncertainty in each signal region, in terms of fractional uncertainty on the total normalization, is shown for the total background prediction in table~\ref{table:systematics-summary}, and some example signal points in tables~\ref{table:systematics-impact-summary-seesaw-160}--\ref{table:systematics-impact-summary-seesaw-500}. The total uncertainty on the background prediction ranges from $6.0\%$ to $8.7\%$ depending on the signal region, while the total uncertainty on the signal predictions range from approximately $4\%$ to $7\%$. 
 %The complete set of tables of signal systematics is in appendix~\ref{appx:signal-uncertainties}.
...
\begin{table}[htbp]
  ...
  \caption{The impact of different sources of uncertainty on the background prediction in each signal region, in terms of percent of the total background normalization.}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline
		\multirow{3}{*}{$WZ$} & $3$ leptons, 0 jets, & \multirow{3}{*}{$WZ$}\\
...
\begin{figure}[htbp]
    \centering
	\subfloat[ Inclusive SR] {
		\resizebox{0.48\textwidth}{!}{\includegraphics{figures/resonance/fit_WZ_hS_nolabel.pdf}}
	}
	\subfloat[ $\threeljj$ SR] {
			\resizebox{0.48\textwidth}{!}{\includegraphics{figures/resonance/fit_WZ_3Ljj_hS_nolabel.pdf}}
         }
...
\begin{figure}[htbp]
    \centering
	\subfloat[ Inclusive SR] {
		\resizebox{0.48\textwidth}{!}{\includegraphics{figures/resonance/fit_ZZ_hS_nolabel.pdf}}
	}
	\subfloat[ $\threeljj$ SR] {
			\resizebox{0.48\textwidth}{!}{\includegraphics{figures/resonance/fit_ZZ_3Ljj_hS_nolabel.pdf}}
         }
...
\begin{figure}[htbp]
    \centering
	\subfloat[ $Z+e$] {
		\resizebox{0.48\textwidth}{!}{\includegraphics{figures/resonance/fit_reducible_Ze_nolabel.pdf}}
	}                                                                                                    
	\subfloat[ $Z+\mu$] {
		\resizebox{0.48\textwidth}{!}{\includegraphics{figures/resonance/fit_reducible_Zmu_nolabel.pdf}}
	}                                                                                                      
...
\centering
	\subfloat[ $Z+\gamma$] {\label{fig:resonance-fits-Zy}
		\includegraphics[width=0.45\textwidth]{figures/resonance/fit_llgamma_Ze_nolabel.pdf}
	}
	\hfill
	\subfloat[ $\ttbarV$ and $VVV^{(*)}$] {\label{fig:resonance-fits-ttV-VVV}
		\includegraphics[width=0.45\textwidth]{figures/resonance/fit_ttV_VVV_nolabel.pdf}
	}
...
\begin{figure}[htbp]
	...
	\subfloat[] {% [$Z+e$, $\fourl$ category] {
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/resonance/c_output_DeltaM_Ze_FourLNoM3L_300GeV_hide_ratio.pdf}}
	}
	\hfill
	\subfloat[] {% [$Z+\mu$, $\fourl$ category] {
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/resonance/c_output_DeltaM_Zmu_FourLNoM3L_300GeV_hide_ratio.pdf}}
	} 
	\\
	\subfloat[] {% [$Z+e$, $\threeljj$ category] {
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/resonance/c_output_DeltaM_Ze_ThreeLDijetNoM3L_300GeV_hide_ratio.pdf}}
	}
	\hfill
	\subfloat[] {% [$Z+\mu$, $\threeljj$ category] {
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/resonance/c_output_DeltaM_Zmu_ThreeLDijetNoM3L_300GeV_hide_ratio.pdf}}
	}
	\\
	\subfloat[] {% [$Z+e$, $\threelo$ category] {
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/resonance/c_output_DeltaM_Ze_ElseNoM3L_300GeV_log.pdf}}
	}
	\hfill
	\subfloat[] {% [$Z+\mu$, $\threelo$ category] {
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/resonance/c_output_DeltaM_Zmu_ElseNoM3L_300GeV_log.pdf}}
	}
...
\begin{figure}[htbp]
  ...
  \caption{Projections onto the $\deltam$ variable of the background-only unbinned maximum-likelihood fits, shown superimposed on the data with the three categories in each flavor channel added together. The $Z+e$ flavor channel is shown in (a), and the $Z+\mu$ channel is shown in (b). The contributions of the separate background components to the total background-only fit are also shown. The error bars on the data points represent statistical uncertainties. Good agreement is observed between the background model and the data.}
  \label{fig:FitResult}
\end{figure}
...
\subsubsection{Model-Independent Limits}\label{sec:resonance-model-independent-limits}
...
\begin{figure}[htbp]
  ...
  \caption{Upper limits at 95\% CL on $\sigmavis$ for the $Z+e$ (left) and $Z+\mu$ (right) flavor channels, derived without dividing events into the three categories. The limits are evaluated in $\SI{3}{\giga\electronvolt}$ intervals.}
  \label{fig:N95}
\end{figure}
