...
\begin{figure}
  ...
  \subfloat[Numerators, log scale] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_ElectronNumerator_pt_log}}
	\label{f:numlogscale}
  }
  \subfloat[Denominators, log scale] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_ElectronDenominatorCombined_pt_log}}
	\label{f:denlogscale}
  } \\
  \subfloat[Numerators, linear scale] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_ElectronNumerator_pt_linear}}
	\label{f:numlinscale}
  }
  \subfloat[Denominators, linear scale] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_ElectronDenominatorCombined_pt_linear}}
	\label{f:denlinscale}
  } \\
...
\begin{figure}[h]
  ...
  \subfloat[Central values] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_FinalFF_2D}}
  }
  \subfloat[Statistical uncertainty over value] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_FinalFF_2D_ErrorOverValue_corr}}
  }
...
\begin{figure}[h] 
  ...
  \subfloat[Average fake factor vs. $p_{\mathrm{T}}$] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_FinalFF_1D_pt}}
  }
  \subfloat[Fake factors vs. $p_{\mathrm{T}}$ for different value of electron $|\eta|$] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_FinalFF_1D_etaslices}}
  }
...
\begin{figure}[h]
  \centering
  \resizebox{5in}{!}{\includegraphics{figures/ch7-modelindependent/c_NumDen_lowPt_eta}}
...
\begin{figure}[h] 
  ...
  \subfloat[Linear scale] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_FinalFF_systematics_linearx_biggerlabels}}
  }
  \subfloat[Log scale] {
	\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_FinalFF_systematics_logx_biggerlabels}}
  }
...
\begin{figure}[h]
  \subfloat[Numerators, 0-jet]{
	\includegraphics[width=0.3\columnwidth]{figures/ch7-modelindependent/num__0jet__nodr}
  }
  \subfloat[Numerators, 1-jet]{
	\includegraphics[width=0.3\columnwidth]{figures/ch7-modelindependent/num__1jet__sldr}
  }
  \subfloat[Numerators, 2-jet]{
	\includegraphics[width=0.3\columnwidth]{figures/ch7-modelindependent/num__2jet__sldr}
  }\\
  \subfloat[Denominators, 0-jet]{
	\includegraphics[width=0.3\columnwidth]{figures/ch7-modelindependent/den__0jet__nodr}
  }
  \subfloat[Denominators, 1-jet]{
	\includegraphics[width=0.3\columnwidth]{figures/ch7-modelindependent/den__1jet__sldr}
  }
  \subfloat[Denoninators, 2-jet]{
	\includegraphics[width=0.3\columnwidth]{figures/ch7-modelindependent/den__2jet__sldr}
  }\\
  \subfloat[Denominators, 0-jet]{
	\includegraphics[width=0.3\columnwidth]{figures/ch7-modelindependent/den__0jet__nodr}
  }
  \subfloat[Denominators, 1-jet]{
	\includegraphics[width=0.3\columnwidth]{figures/ch7-modelindependent/den__1jet__nodr}
  }
  \subfloat[Denominators, 2-jet]{
	\includegraphics[width=0.3\columnwidth]{figures/ch7-modelindependent/den__2jet__nodr}
  }
...
\begin{figure}[h]
\centering \includegraphics[width=0.48\textwidth]{figures/ch7-modelindependent/MuFake_extrap_ratio}
...
\begin{figure}
\centering \includegraphics[width=0.48\textwidth]{figures/ch7-modelindependent/all_1D_pt}
%\centering \includegraphics[width=0.48\textwidth]{figures/ch7-modelindependent/MuFake_ff_vseta}
...
\begin{figure}
  \subfloat[Inclusive FF] {
	\resizebox{0.48\textwidth}{!}{\includegraphics{figures/ch7-modelindependent/ff_0jet_final}}
  }
  \subfloat[Two-jet FF] {
	\resizebox{0.48\textwidth}{!}{\includegraphics{figures/ch7-modelindependent/ff_2jet_final}}
  }
...
\begin{figure}
  \centering
  \subfloat[ Inclusive FF] {
	\resizebox{0.48\textwidth}{!}{\includegraphics{figures/ch7-modelindependent/MuFake_syst_nom}}
  }
  \subfloat[ Two-jet FF] {
	\resizebox{0.48\textwidth}{!}{\includegraphics{figures/ch7-modelindependent/MuFake_syst_2jet}}
  }
...
\begin{figure}[h]
	...
	\subfloat[ Inclusive SR, $Z+e$] {
		\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_output_reducible_DeltaM_Ze_InclusiveNoM3L}}
	}
	\subfloat[ Inclusive SR, $Z+\mu$] {
		\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_output_reducible_DeltaM_Zmu_InclusiveNoM3L}}
	} \\
	\subfloat[ 4L SR, $Z+e$] {
		\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_output_reducible_DeltaM_Ze_FourLNoM3L}}
	}
	\subfloat[ 4L SR, $Z+\mu$] {
		\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_output_reducible_DeltaM_Zmu_FourLNoM3L}}
	} \\
	\subfloat[ 3L+dijet SR, $Z+e$] {
		\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_output_reducible_DeltaM_Ze_ThreeLDijetNoM3L}}
	}
	\subfloat[ 3L+dijet SR, $Z+\mu$] {
		\resizebox{3in}{!}{\includegraphics{figures/ch7-modelindependent/c_output_reducible_DeltaM_Zmu_ThreeLDijetNoM3L}}
	} \\
...
\begin{figure}
\centering \includegraphics[width=0.48\textwidth]{figures/ch7-modelindependent/TauFakes_NumM}
\centering \includegraphics[width=0.48\textwidth]{figures/ch7-modelindependent/TauFakes_NumPt}
\centering \includegraphics[width=0.48\textwidth]{figures/ch7-modelindependent/TauFakes_DenM}
\centering \includegraphics[width=0.48\textwidth]{figures/ch7-modelindependent/TauFakes_DenPt}
...
%\centering \includegraphics[width=0.48\textwidth]{figures/ch7-modelindependent/TauFakes_NJetsDep}
...
\begin{figure}[htbp]
  \subfloat[$ee$]{
    \includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/DYOSee_cut_3f_AllLeptonMass}
  }
  \subfloat[$\mu\mu$]{
    \includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/DYOSmm_cut_3f_AllLeptonMass}
  }
...
\begin{figure}[tbp]
  \subfloat[Electron \pt\ Scale Factors]{
    \includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/c_e_pt_allSF}
  }
  \subfloat[Electron $|\eta|$ Scale Factors]{
    \includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/c_e_eta_allSF}
  }
  \subfloat[Muon \pt\ Scale Factors]{
    \includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/c_m_pt_allSF}
  }
  \subfloat[Muon $|\eta|$ Scale Factors]{
    \includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/c_m_eta_allSF}
  }
...
\begin{figure}[htbp]
	\subfloat[Leading Lepton \pt]
		{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/OSZ_LeadingPt}}
	\subfloat[Leading Lepton $|\eta|$]
		{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/OSZ_LeadingEta}}
	\subfloat[Subleading Lepton \pt]
		{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/OSZ_SubleadPt}}
	\subfloat[Subleading Lepton $|\eta|$]
		{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/OSZ_SubleadEta}}
...
\begin{figure}[tbp]
  \subfloat[Leading Lepton \pt]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/semileptop_emu_mue_LeadPt}}
  \subfloat[Leading Lepton $|\eta|$]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/semileptop_emu_mue_LeadEta}}
  \subfloat[Subleading Lepton \pt]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/semileptop_emu_mue_SubleadPt}}
  \subfloat[Subleading Lepton $|\eta|$]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/semileptop_emu_mue_SubleadEta}}
  \subfloat[\meff]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/semileptop_emu_mue_ST}}
  \subfloat[\met]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/semileptop_emu_mue_MET}}
...
\begin{figure}[tbp]\centering
  \subfloat[Event Composition]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zmm_offZe_intelec_Simple3LEventClassification}}
  \subfloat[Electron \pt]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zmm_offZe_intelec_OffZPt}}
  \subfloat[Electron $\eta$]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zmm_offZe_intelec_OffZEta}}
  \subfloat[Electron \mt]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zmm_offZe_intelec_OffZMT}}
  \subfloat[\meff]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zmm_offZe_intelec_ST}}
  \subfloat[\met]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zmm_offZe_intelec_MET}}
...
\begin{figure}[tbp]\centering
  \subfloat[Event Composition]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zee_offZmu_intmuon_Simple3LEventClassification}}
  \subfloat[Muon \pt]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zee_offZmu_intmuon_OffZPt}}
  \subfloat[Muon $\eta$]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zee_offZmu_intmuon_OffZEta}}
  \subfloat[Muon
    \mt]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zee_offZmu_intmuon_OffZMT}}
  \subfloat[\meff]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zee_offZmu_intmuon_ST}}
  \subfloat[\met]{\includegraphics[width=.48\columnwidth]{figures/ch7-modelindependent/Z_emu_Zee_offZmu_intmuon_MET}}
...
\begin{figure}[tbp]\centering
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $p_{T}$, on-$Z$]{\includegraphics[width=.44\columnwidth]{figures/ch7-modelindependent/inttau_onZ_DY_TauPt}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $\eta$, on-$Z$]{\includegraphics[width=.44\columnwidth]{figures/ch7-modelindependent/inttau_onZ_DY_TauEta}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $p_{T}$, off-$Z$/OSSF]{\includegraphics[width=.44\columnwidth]{figures/ch7-modelindependent/inttau_offZ_OSSF_DY_TauPt}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $\eta$, off-$Z$/OSSF]{\includegraphics[width=.44\columnwidth]{figures/ch7-modelindependent/inttau_offZ_OSSF_DY_TauEta}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $p_{T}$, off-$Z$/mixed]{\includegraphics[width=.44\columnwidth]{figures/ch7-modelindependent/inttau_offZ_mixed_DY_TauPt}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $\eta$, off-$Z$/mixed]{\includegraphics[width=.44\columnwidth]{figures/ch7-modelindependent/inttau_offZ_mixed_DY_TauEta}}
