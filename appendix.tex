...
%The analyses presented in chapters~\ref{ch:model-independent-trilepton-search} and \ref{ch:trilepton-resonance-search} both employ a modified frequentist approach to the statistical limit setting known as the $CL_s$ method~\cite{cls}. The method 
