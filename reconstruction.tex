...
\begin{figure}[htbp]
	\centering
	\subfloat[ $|\eta|<1$] {
		\resizebox{0.6\textwidth}{!}{\includegraphics{figures/reconstruction/mu_fig_14a}}
	}
	\hfill
	\subfloat[ $1<|\eta|<2$] {
		\resizebox{0.6\textwidth}{!}{\includegraphics{figures/reconstruction/mu_fig_14b}}
	}
	\hfill
	\subfloat[ $|\eta|>2$] {
		\resizebox{0.6\textwidth}{!}{\includegraphics{figures/reconstruction/mu_fig_14c}}
	}
