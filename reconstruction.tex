...
\begin{figure}[htbp]
	\centering
	\subfloat[] {
		\resizebox{0.49\textwidth}{!}{\includegraphics{figures/reconstruction/el_eff_idplusreco_ET}}
	}
	\hfill
	\subfloat[] {
		\resizebox{0.49\textwidth}{!}{\includegraphics{figures/reconstruction/el_eff_idplusreco_eta}}
	}
