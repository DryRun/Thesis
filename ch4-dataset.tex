\chapter{Dataset and Luminosity Measurement}\label{ch:dataset-luminosity}
\begin{figure}[htbp]
	\centering
	\hfill
	\subfloat[] {\label{fig:reco-luminosity-runI}
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/ch4-dataset/intlumivstime2011-2012DQ.eps}}
	}
	\hfill
	\subfloat[] {\label{fig:reco-luminosity-pileup}
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/ch4-dataset/mu_2011_2012-dec.eps}}
	}
	\hfill
...
\begin{figure}
	...
	\subfloat[] {\label{fig:reco-luminosity-comparisons-long-term-stability}
		\resizebox{0.45\textwidth}{!}{\includegraphics{figures/ch4-dataset/luminosity_long_term_stability}}
	}
	\hfill
	\subfloat[] {\label{fig:reco-luminosity-comparisons-pileup}
		\resizebox{0.45\textwidth}{!}{\includegraphics{figures/ch4-dataset/luminosity_pileup_muscan}}
	}
	\hfill
...
\begin{figure}[h]
	\centering
	\resizebox{5in}{!}{\includegraphics{figures/ch4-dataset/c_truefakemu_NGenInt.pdf}}
...
\begin{figure}[h]
	...
	\subfloat[$\mu_{\textrm{fake}}$ vs. number of generated interactions per event.] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_mu_fake_NGenInt.png}}
	}
	\subfloat[$\mu_{\textrm{fake}}$ vs. $\mu_{\textrm{inel}}$.] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_mu_fake_mu.png}}
	}\\
	\subfloat[$\mu_{\textrm{fake}}$ vs. $\mu_{\textrm{rec}}$ after masking correction.] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_mu_fake_MuReconMC.png}}
		\label{fig:fake-mu-murecmc}
	}
	\subfloat[$\mu_{\textrm{fake}} / \mu_{\textrm{rec}}$ vs. $\mu_{\textrm{rec}}$ after masking correction.] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_fake_fraction_MuReconMC.png}}
...
\begin{figure}[p]
	...
	\subfloat[$\Delta z$ distribution and template fit, NTrk5, BCID 81] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_dz_NTrk5_BCID81}}
	}
	\subfloat[$p_{\textrm{mask}}(\Delta z)$, NTrk5] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_pmask_dz_NTrk5}}
	}\\
	\subfloat[$\Delta z$ distribution and template fit, NTrk7, BCID 81] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_dz_NTrk7_BCID81}}
	}
	\subfloat[$p_{\textrm{mask}}(\Delta z)$, NTrk7] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_pmask_dz_NTrk7}}
	}\\
	\subfloat[$\Delta z$ distribution and template fit, NTrk10, BCID 81] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_dz_NTrk10_BCID81}}
	}
	\subfloat[$p_{\textrm{mask}}(\Delta z)$, NTrk10] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_pmask_dz_NTrk10}}
	}\\
...
\begin{figure}[p]
	...
	\subfloat[$\Delta z$ distribution and template fit, NTrk5] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_dz_NTrk5}}
	}
	\subfloat[$p_{\textrm{mask}}(\Delta z)$, NTrk5] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_pmask_dz_NTrk5}}
	}\\
	\subfloat[$\Delta z$ distribution and template fit, NTrk7] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_dz_NTrk7}}
	}
	\subfloat[$p_{\textrm{mask}}(\Delta z)$, NTrk7] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_pmask_dz_NTrk7}}
	}\\
	\subfloat[$\Delta z$ distribution and template fit, NTrk10] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_dz_NTrk10}}
	}
	\subfloat[$p_{\textrm{mask}}(\Delta z)$, NTrk10] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_pmask_dz_NTrk10}}
	}\\
...
\begin{figure}[p]
	...
	\subfloat[$x$ scan, BCID 81] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_musp_x_BCID81_NTrkCut5}}
	}
	\subfloat[$y$ scan, BCID 81] {
		\resizebox{3in}{!}{\includegraphics{figures/ch4-dataset/c_musp_y_BCID81_NTrkCut5}}
	}\\
...
\begin{figure}[h]
	\centering
	\subfloat[BCID 200] {
		\resizebox{6.5in}{!}{\includegraphics{figures/ch4-dataset/c_pileup_corrections_NVtx_BCID200}}
	}\\
	\subfloat[BCID 999] {
		\resizebox{6.5in}{!}{\includegraphics{figures/ch4-dataset/c_pileup_corrections_NVtx_BCID999}}
	}
...
\begin{figure}[h]
	\centering
	\resizebox{6in}{!}{\includegraphics{figures/ch4-dataset/c_muscan}}
...
\begin{figure}[h]
	\centering
	\resizebox{5in}{!}{\includegraphics{figures/ch4-dataset/c_lumi_combined_191373.pdf}}
