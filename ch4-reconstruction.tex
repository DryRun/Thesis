...
\begin{figure}[htbp]
	...
	\subfloat[] {\label{fig:reco-luminosity-runI}
		\resizebox{0.4\textwidth}{!}{\includegraphics{figures/ch4-reconstruction/intlumivstime2011-2012DQ}}
	}
	\hfill
...
\subsection{Electrons and Photons}\label{sec:event-reconstruction-electrons}
