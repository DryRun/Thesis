...
\begin{figure}[htbp]
	...
	\caption{The central solenoid in the factory after completion of the coil winding~\cite{ }.}
	\label{fig:solenoid}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\resizebox{0.4\textwidth}{!}{\includegraphics{figures/experiment/ATLAS_trigger_L1_block}}
