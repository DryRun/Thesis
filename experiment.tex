...
\begin{figure}[htbp]
	\centering
	\resizebox{0.4\textwidth}{!}{\includegraphics{figures/experiment/LHC_IPs}}
...
\begin{figure}[htbp]
	\centering
	\resizebox{0.6\textwidth}{!}{\includegraphics{figures/experiment/ATLAS_solenoid_Bfield}}
...
\begin{figure}[htbp]
	\centering
	\resizebox{0.6\textwidth}{!}{\includegraphics{figures/experiment/ATLAS_toroid_Bintegral}}
