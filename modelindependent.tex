...
%The search uses $20.3~\ifb$ of $pp$ collision data taken at $\sqrt{s}=8~\mbox{TeV}$ with the ATLAS detector. 
...
The $\mu\tau_{\mathrm{had}}$ region applies addition cuts to reduce the large contribution from fake $\tau$ leptons in $W$+jets events:
...
where $\mathcal{L}=20.3~\mbox{fb}^{-1}$ is the integrated luminosity of the data. The limits are calculated using a modified frequentist $CL_s$ prescription~\cite{cls}, described in more detail in appendix~\ref{appx:statistics}. 
...
\begin{figure}[htbp]
  ...
  \vspace{-0.25in}
  \subfloat[] {
    \resizebox{0.45\textwidth}{!}{\includegraphics{figures/modelindependent/all_onZ_emu_tau_All_all_SumTrilepPt.pdf}}
  }
  \hfill
  \subfloat[] {
    \resizebox{0.45\textwidth}{!}{\includegraphics{figures/modelindependent/all_onZ_emu_All_all_SumTrilepPt.pdf}}
  } \\
  \subfloat[] {
    \resizebox{0.45\textwidth}{!}{\includegraphics{figures/modelindependent/all_offZ_mixed_emu_tau_All_all_SumTrilepPt.pdf}}
  }
  \hfill
  \subfloat[] {
    \resizebox{0.45\textwidth}{!}{\includegraphics{figures/modelindependent/all_offZ_mixed_emu_All_all_SumTrilepPt.pdf}}
  } \\
  \subfloat[] {
    \resizebox{0.45\textwidth}{!}{\includegraphics{figures/modelindependent/all_offZ_OSSF_emu_tau_All_all_SumTrilepPt.pdf}}
  }
  \hfill
  \subfloat[] {
    \resizebox{0.45\textwidth}{!}{\includegraphics{figures/modelindependent/all_offZ_OSSF_emu_All_all_SumTrilepPt.pdf}}
  }
...
\begin{figure}
	\centering
  \resizebox{0.95\textwidth}{!}{\includegraphics{figures/modelindependent/summary_limits.pdf}}
...
\begin{figure}
	\centering
  \resizebox{0.95\textwidth}{!}{\includegraphics{figures/modelindependent/summary_limit_pulls.pdf}}
