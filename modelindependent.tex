...
\begin{figure}[htbp]
  \subfloat[$ee$]{
    \includegraphics[width=.48\columnwidth]{figures/modelindependent/DYOSee_cut_3f_AllLeptonMass}
  }
  \subfloat[$\mu\mu$]{
    \includegraphics[width=.48\columnwidth]{figures/modelindependent/DYOSmm_cut_3f_AllLeptonMass}
  }
...
\begin{figure}[htbp]
	\subfloat[Leading Lepton \pt]
		{\includegraphics[width=.48\columnwidth]{figures/modelindependent/OSZ_LeadingPt}}
	\subfloat[Leading Lepton $|\eta|$]
		{\includegraphics[width=.48\columnwidth]{figures/modelindependent/OSZ_LeadingEta}}
	\subfloat[Subleading Lepton \pt]
		{\includegraphics[width=.48\columnwidth]{figures/modelindependent/OSZ_SubleadPt}}
	\subfloat[Subleading Lepton $|\eta|$]
		{\includegraphics[width=.48\columnwidth]{figures/modelindependent/OSZ_SubleadEta}}
...
\begin{figure}[tbp]\centering
  ...
  \subfloat[Muon
    \mt]{\includegraphics[width=.48\columnwidth]{figures/modelindependent/Z_emu_Zee_offZmu_intmuon_OffZMT}}
...
\begin{figure}[tbp]\centering
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $p_{T}$, on-$Z$]{\includegraphics[width=.44\columnwidth]{figures/modelindependent/inttau_onZ_DY_TauPt}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $\eta$, on-$Z$]{\includegraphics[width=.44\columnwidth]{figures/modelindependent/inttau_onZ_DY_TauEta}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $p_{T}$, off-$Z$/OSSF]{\includegraphics[width=.44\columnwidth]{figures/modelindependent/inttau_offZ_OSSF_DY_TauPt}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $\eta$, off-$Z$/OSSF]{\includegraphics[width=.44\columnwidth]{figures/modelindependent/inttau_offZ_OSSF_DY_TauEta}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $p_{T}$, off-$Z$/mixed]{\includegraphics[width=.44\columnwidth]{figures/modelindependent/inttau_offZ_mixed_DY_TauPt}}
  \subfloat[Intermediate $\tau_{\mathrm{had}}$ $\eta$, off-$Z$/mixed]{\includegraphics[width=.44\columnwidth]{figures/modelindependent/inttau_offZ_mixed_DY_TauEta}}
